...
function SkillsText() {
  ...
  return (
    <section>
        <h3 className='text-3xl py-1 mx-auto text-center mb-2'>My skills as a Fullstack Developer</h3>
        ...
        <div className='lg:flex gap-10'>
            ...
            <h3 className="text.lg font-medium pt-4 pb-2">Frontend</h3>
            ...
            <h4 className='py-2 text-teal-600'>Tools including:</h4>
            ...
            <h3 className="text.lg font-medium pt-4 pb-2">Backend</h3>
            ...
            <div className='text-center shadow-xl p-10 rounded-xl'>
            <h3 className="text.lg font-medium pt-4 pb-2">Agile Methods</h3>
            ...
            <h4 className='py-2 text-teal-600'>Tools including:</h4>
            <p className="text-gray-800 py-1">Agile Scrum Methodology</p>
            <p className="text-gray-800 py-1">Closed-Loop Communication</p>
            <p className="text-gray-800 py-1">My Social Maturity & Caring Personality</p>
            </div>
        </div>
