...
function ContactText() {
  ...
  return (
    <section>
         <h3 className='text-3xl mt-5 font-bold text-slate-300 mx-auto text-center mt-10'>Contact Information</h3>

         <div className='shadow-xl p-5 rounded-xl max-w-md m-auto bg-slate-100 mt-10'>
