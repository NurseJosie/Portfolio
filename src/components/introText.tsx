...
function IntroText() {
  ...
  return (
    <section className="text-center py-5">
        <h2 className='text-5xl py-2  text-slate-300 font-bold md:text-6xl'>Josefin Persson</h2>
        <h3 className='text-2xl py-2 font-bold text-slate-100 md:text-3xl'>Software Developer</h3>
  
       
       <div className='mx-5 mt-10 flex flex-col md:flex-row justify-center gap-10'>

       <img src="public/profil-1-2023-square.jpg" alt="" className="self-center w-80 max-w-lg rounded-2xl shadow-black shadow-2xl" ></img>
        
  

        <p className='bg-slate-100 max-w-lg text-md p-5 text-gray-900 md:text-xl shadow-black shadow-2xl rounded-2xl'>Dedicated and enthusiastic Junior Full Stack Developer,
