...
function IntroText() {
  ...
  return (
    <section className="text-center p-10">
        <h2 className='text-5xl py-2 text-green-700 font-bold md:text-6xl'>Josefin Persson</h2>
       ...
       <div className='md:grid grid-cols-3 gap-5'>
        ...
        <img src="src\assets\profil-1-2023-square.jpg" alt="" className="m-auto rounded-3xl p-5 w-30"></img>
