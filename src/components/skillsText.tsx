...
function SkillsText() {
  ...
  return (
    <section>
        <h3 className='text-slate-300 text-3xl mt-5 font-bold mx-auto text-center mb-2'>My skills as a Fullstack Developer</h3>
        <p className='mx-auto text-center text-md py-2 text-slate-100 md:text-lg max-w-4xl'>
